...
resume_json_folder = os.path.dirname(sample_json_path)

temp_root = os.path.abspath(os.path.join(resume_json_folder, "..", ".."))
chroma_base_dir = os.path.join(temp_root, "chromadb_resume")
